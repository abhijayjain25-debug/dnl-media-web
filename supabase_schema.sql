...
CREATE TABLE IF NOT EXISTS public.settings (
    ...
    website_line TEXT DEFAULT 'www.delhinewslive.co.in',
...
SET website_line = 'www.delhinewslive.co.in' 
WHERE website_line = 'www.delhinewslive.in' OR website_line IS NULL;
